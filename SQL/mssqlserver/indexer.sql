...
create index smf_instanceID_index on  [dbo].[t_assistant](InstanceID)
create index smf_nodeid_index on  [dbo].[t_assistant](NodeID)
...
create index smf_transitionid_index on  [dbo].[t_cooperation](TransitionID)
create index smf_instanceID_index on [dbo].[t_cooperation](InstanceID)
create index smf_nodeid_index on [dbo].[t_cooperation](NodeID)
